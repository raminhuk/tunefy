    ...
    return (
        <div>
            <div>
                ...
                <div className="" style={idTrack !== null ? { display: 'block' } : { display: 'none' }}>
                    <Draggable defaultClassName='absolute bottom-0 right-4'>
                ...
                <div className="text-center max-w-7xl mx-auto">
                    ...
                    <div className="flex justify-between gap-2 mb-4">
                        <button
                            ...
                            className={`text-xs lg:text-base flex-1 ${timeRange === 'short_term' ? 'bg-gradient-to-r from-customPink to-customBlue' : 'bg-zinc-900 border border-zinc-800 hover:border-black'} hover:bg-gradient-to-r from-customPink to-customBlue text-white px-1 py-3 rounded`}
                        >
                            Último mês
                        </button>
                        <button
                            onClick={() => handleTimeRangeChange('medium_term')}
                            className={`text-xs lg:text-base flex-1 ${timeRange === 'medium_term' ? 'bg-gradient-to-r from-customPink to-customBlue' : 'bg-zinc-900 border border-zinc-800 hover:border-black'} hover:bg-gradient-to-r from-customPink to-customBlue text-white px-1 py-3 rounded`}
                        >
                            Últimos 6 meses
                        </button>
                        <button
                            onClick={() => handleTimeRangeChange('long_term')}
                            className={`text-xs lg:text-base flex-1 ${timeRange === 'long_term' ? 'bg-gradient-to-r from-customPink to-customBlue' : 'bg-zinc-900 border border-zinc-800 hover:border-black'} hover:bg-gradient-to-r from-customPink to-customBlue text-white px-1 py-3 rounded`}
                        >
                            Todos os tempos
                        </button>
                    </div>
